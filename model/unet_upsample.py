...
def get_unet7_up(img_rows, img_cols, dim_in, dim_out, act_fun='elu', out_fun='sigmoid'):
    name="_unet7_up"
    ...
    conv7 = Conv2D(f7, (3, 3), activation=act_fun, padding='same')(pool6)
    conv7 = Conv2D(f7, (3, 3), activation=act_fun, padding='same')(conv7)
    ...
    decon6 = Conv2D(f6, (3, 3), activation=act_fun, padding='same')(up6)
    decon6 = Conv2D(f6, (3, 3), activation=act_fun, padding='same')(decon6)
