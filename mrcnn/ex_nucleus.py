...
COCO_WEIGHTS_PATH = "d:/mask_rcnn_coco.h5"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', required=False, default='D:/kaggle_nucleus/logs/nucleus20180807T1553/mask_rcnn_nucleus_0004.h5',
                        metavar="/path/to/weights.h5",
                        help="Path to weights .h5 file or 'coco'")
    parser.add_argument('--logs', required=False, default=DEFAULT_LOGS_DIR,
                        metavar="/path/to/logs/",
                        help='Logs and checkpoints directory (default=logs/)')
    parser.add_argument('--subset', required=False, default='stage1_train',
