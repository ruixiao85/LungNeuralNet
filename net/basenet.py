...
class Net(Config):
    ...
    def __init__(self, dim_in=None, dim_out=None, act=None, out=None, loss=None, metrics=None, optimizer=None,
        ...
        self.indicator='val_dice' if self.dep_out==1 else 'val_acc'  # indicator to maximize
