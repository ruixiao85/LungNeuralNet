# unet_tf is free software: you can redistribute it and/or modify
# it under the terms of the GNU General Public License as published by
# the Free Software Foundation, either version 3 of the License, or
# (at your option) any later version.
#
# unet_tf is distributed in the hope that it will be useful,
# but WITHOUT ANY WARRANTY; without even the implied warranty of
# MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
# GNU General Public License for more details.
#
# You should have received a copy of the GNU General Public License
# along with unet_tf.  If not, see <http://www.gnu.org/licenses/>.
...
from unet_tf import util_t as util
from unet_tf.layers import (weight_variable, weight_variable_devonc, bias_variable,
...
class Unet(object):
    ...
    def predict(self, model_path, x_test):
        """
        Uses the unet to create a prediction for the given data
        :param model_path: path to the unet checkpoint to restore
        ...
        with tf.Session() as sess:
            ...
            # Restore unet weights from previously saved unet
...
class Trainer(object):
    ...
    def train(self, data_provider, output_path, training_iters=10, epochs=100, dropout=0.75, display_step=1,
        ...
        :param restore: Flag if previous unet should be restored
        :param write_graph: Flag if the computation graph should be written as protobuf file to the output path
        :param prediction_path: path where to save predictions on each epoch
        """
        save_path = os.path.join(output_path, "unet.ckpt")
        if epochs == 0:
            return save_path
