...
class Config:
    def __init__(self,num_targets,target_scale,**kwargs,):
        ...
        self.train_val_aug=kwargs.get('train_val_aug',(4,0))  # only to training process two values each for tr and val set, applies to image-mask set and image+patch
        ...
        self.is_train=None # will set when build network
