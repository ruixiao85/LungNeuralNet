...
from retinanet.utils.visualization import draw_annotations, draw_boxes, draw_caption
from retinanet.utils.colors import label_color
from retinanet.utils.config import read_config_file

# Allow relative imports when being executed as script.
if __name__ == "__main__" and __package__ is None:
    sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..', '..'))
    import retinanet.bin
    __package__ = "maskrcnn.bin"
