...
import keras.models
import retinanet.layers
import retinanet.models.retinanet
...
def retinanet_mask(
    ...
    **kwargs
    ...
    # Arguments
        ...
        retinanet_model : retinanet.models.retinanet model, returning regression and classification values.
    ...
    if anchor_params is None:
        anchor_params = retinanet.utils.anchors.AnchorParameters.default
    ...
    if retinanet_model is None:
        retinanet_model = retinanet.models.retinanet.retinanet(inputs=image, num_classes=num_classes, **kwargs)
    ...
    # build boxes
    anchors = retinanet.models.retinanet.__build_anchors(anchor_params, features)
    boxes = retinanet.layers.RegressBoxes(name='boxes')([anchors, regression])
    boxes = retinanet.layers.ClipBoxes(name='clipped_boxes')([image, boxes])
    ...
    detections = retinanet.layers.FilterDetections(nms=nms, class_specific_filter=class_specific_filter, name='filtered_detections')([top_boxes, top_classification] + other + maskrcnn_outputs)
